...
(function () {
  ...
  var ISO = {
    ...
    "ISO 30400": { en: "Human resource management — Vocabulary", mn: "Хүний нөөцийн менежментийн нэр томьёо",
      d: "Хүний нөөцийн менежментийн стандартуудад ашиглах нэр томьёо, тодорхойлолтыг нэгтгэн стандартчилсан суурь баримт бичиг. ISO 30400:2016." },
  ...
  var MEMBERS = {
    ...
    chantsalnyam: {
      role: "Ерөнхий зөвлөх", name: "Ж.Чанцалням", prof: "Хүний нөөцийн менежер",
      bio: "Процесс болон хүний нөөцийн үндсэн функцуудыг уялдуулан, стандартын шаардлагад нийцсэн баримт бичиг боловсруулах туршлагатай.",
      more: [],
      certs: ["ISO 9001", "ISO 30400"]
    }
  };
